                ...
                <table
                                    ...
                                    list.approveType === 0 && list.secondApprover == rejectedPerson ? (
                                            <div style={{marginBottom: '10px', textAlign: 'center'}}>
                                                ...
                                                <Button variant='outlined' color='warning'
                                                        onClick={() => handleRejectionDetailOpen('second')}>
                                                    중간 승인자 반려 사유
                                                </Button>
                                            </div>
                                        ) :
                                        list.approveType > 1 ? (
                                            ...
                                            list.approveType === 1 && memberId === list.secondApprover ? (
                                                <>
                                                    <Button variant='outlined' color='warning'
                                                            onClick={acception}>승인</Button>
                                                    <Button variant='outlined' color='warning'
                                                            onClick={handleRejectionOpen}>반려</Button>
                                                </>
                                            ) : ''
                            }
                    ...
                    <tr>
                        <td className="stampFirst"
                            style={{fontSize: '23px', height: '50px', textAlign: 'center'}}>{list.firstApprover}</td>
                        <td className="stampSecond"
                            style={{fontSize: '23px', textAlign: 'center'}}>{list.secondApprover}</td>
                        <td className="stampThird"
                            style={{fontSize: '23px', textAlign: 'center'}}>{list.thirdApprover}</td>
                    </tr>
                    <tr>
                        <td style={{minWidth: '90px', fontSize: '23px'}}>성명</td>
                        <td style={{fontSize: '23px', width: '20%', outline: 'none', height: '50px'}}>{list.writer}</td>
                        <td style={{width: '20%', fontSize: '23px'}}>부서</td>
                        <td colSpan={2}
                            style={{fontSize: '23px', width: '175px', outline: 'none'}}>{list.department}</td>
                        <td style={{minWidth: '90px', fontSize: '23px'}}>직급</td>
                        <td colSpan={2} style={{fontSize: '23px', width: '175px', outline: 'none'}}>{list.position}</td>
                            ...
                            <>
                                ...
                                {details.map((detail, index) => (
                                    <tr key={index}>
                                        ...
                                        <td colSpan={3}
                                            style={{fontSize: '23px', textAlign: 'right', paddingRight: '20px'}}>
